...
lm_model_chl <- lm(shannon_index ~ avg_chl_a, data = shannon_with_season_gam)
...
lm_model_sal <- lm(shannon_index ~ Salinity_Avg, data = shannon_with_season_gam)
...
lm_model_secchi <- lm(shannon_index ~ Secchi.depth, data = shannon_with_season_gam)
